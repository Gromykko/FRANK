...
export const FORECAST_MODEL_REVISION = 54;
...
// renamed field, or new envelope metadata required to prove its completeness.
// Adding an optional SeriesPoint field does not need a bump because older
// readers ignore it. Bumping moves both the raw key and generation prefix,
// which retires the ingredients and everything assembled from them together.
export const MARINE_INGREDIENT_CACHE_SCHEMA_VERSION = 2;
...
export const FORECAST_DATA_GENERATION_ID = 'api1-model54';
